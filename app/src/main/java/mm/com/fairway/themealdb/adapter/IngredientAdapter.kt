...
class IngredientAdapter(var mealList: ArrayList<Meal> = ArrayList()):RecyclerView.Adapter<IngredientAdapter.IngredientViewHolder>() {
    ...
    fun updateIngredient(mealList: ArrayList<Meal>) {
        this.mealList = mealList
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IngredientViewHolder {
        return IngredientViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_letterlist_layout,parent,false))
    }
